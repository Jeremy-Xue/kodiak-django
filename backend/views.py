...
def generate_token(e_ids):
    ...
    h = hash(''.join(e_ids.map(lambda x: str(x))))
...
def send_email(token="", parent_email="", child="", activity=""):
    confirm_route = "http://injuredroman.github.io/kodiak_sign_up/#/confirm_enrollment/%s"%(token)
            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        ...
                        <p>Please confirm or cancel {}'s enrollment in {}, from {} to {}, between {} and {}.</p>

                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href= {}" class="button">Confirm Enrollment</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
...
</html>""".format(child.first_name, activity.title, activity.start_date, activity.end_date, activity.start_time, activity.end_time, confirm_route)
    return send_mail(subject, message, from_email, recipient_list, fail_silently=False, html_message=html_message)
